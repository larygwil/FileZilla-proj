...
void init()
{
	...
	// Tweaked values
	material_values[pieces::pawn]   = score( 74, 86 );
	material_values[pieces::knight] = score( 351, 399 );
	material_values[pieces::bishop] = score( 388, 407 );
	material_values[pieces::rook]   = score( 518, 677 );
	material_values[pieces::queen]  = score( 1114, 1233 );
	double_bishop                   = score( 54, 35 );
	passed_pawn_advance_power       = score( 198, 151 );
	passed_pawn_king_distance[0]    = score( 0, 6 );
	passed_pawn_king_distance[1]    = score( 0, 4 );
	passed_pawn_base[0]             = score( 5, 12 );
	passed_pawn_base[1]             = score( 0, 3 );
	passed_pawn_base[2]             = score( 1, 1 );
	passed_pawn_base[3]             = score( 1, 0 );
	doubled_pawn_base[0][0]         = score( 36, 5 );
	doubled_pawn_base[0][1]         = score( 3, 1 );
	doubled_pawn_base[0][2]         = score( 10, 0 );
	doubled_pawn_base[0][3]         = score( 0, 0 );
	...
	candidate_passed_pawn_base[0]   = score( 18, 24 );
	candidate_passed_pawn_base[1]   = score( 0, 3 );
	candidate_passed_pawn_base[2]   = score( 6, 7 );
	candidate_passed_pawn_base[3]   = score( 6, 8 );
	pawn_shield[0]                  = score( 23, 3 );
	pawn_shield[1]                  = score( 15, 2 );
	pawn_shield[2]                  = score( 7, 1 );
	pawn_shield[3]                  = score( 2, 1 );
	pawn_shield_attack[0]           = score( 20, 32 );
	pawn_shield_attack[1]           = score( 5, 11 );
	pawn_shield_attack[2]           = score( 5, 7 );
	pawn_shield_attack[3]           = score( 3, 1 );
	absolute_pin[2]                 = score( 1, 30 );
	absolute_pin[3]                 = score( 17, 21 );
	absolute_pin[4]                 = score( 33, 1 );
	absolute_pin[5]                 = score( 1, 1 );
	rooks_on_open_file              = score( 22, 18 );
	rooks_on_half_open_file         = score( 7, 9 );
	connected_rooks                 = score( 2, 1 );
	tropism[1]                      = score( 3, 1 );
	tropism[2]                      = score( 2, 1 );
	tropism[3]                      = score( 1, 1 );
	tropism[4]                      = score( 3, 1 );
	...
	rule_of_the_square              = score( 0, 7 );
	passed_pawn_unhindered          = score( 0, 7 );
	defended_by_pawn[1]             = score( 0, 8 );
	defended_by_pawn[2]             = score( 8, 4 );
	defended_by_pawn[3]             = score( 4, 0 );
	defended_by_pawn[4]             = score( 7, 1 );
	defended_by_pawn[5]             = score( 0, 1 );
	attacked_piece[1]               = score( 1, 19 );
	attacked_piece[2]               = score( 0, 19 );
	attacked_piece[3]               = score( 8, 2 );
	attacked_piece[4]               = score( 4, 29 );
	attacked_piece[5]               = score( 20, 23 );
	hanging_piece[1]                = score( 1, 20 );
	hanging_piece[2]                = score( 6, 12 );
	hanging_piece[3]                = score( 15, 19 );
	hanging_piece[4]                = score( 20, 28 );
	hanging_piece[5]                = score( 22, 18 );
	mobility_knight_min             = score( -6, 0 );
	mobility_knight_max             = score( 31, 30 );
	mobility_knight_rise            = score( 10, 12 );
	mobility_knight_offset          = score( 0, 3 );
	mobility_bishop_min             = score( -43, -7 );
	mobility_bishop_max             = score( 4, 72 );
	mobility_bishop_rise            = score( 7, 9 );
	mobility_bishop_offset          = score( 0, 0 );
	mobility_rook_min               = score( 0, -15 );
	mobility_rook_max               = score( 6, 38 );
	mobility_rook_rise              = score( 2, 15 );
	mobility_rook_offset            = score( 2, 5 );
	mobility_queen_min              = score( 0, -52 );
	mobility_queen_max              = score( 14, 48 );
	mobility_queen_rise             = score( 1, 48 );
	mobility_queen_offset           = score( 1, 0 );
	side_to_move                    = score( 9, 0 );
	rooks_on_rank_7                 = score( 8, 39 );
	knight_outposts[0]              = score( 16, 10 );
	knight_outposts[1]              = score( 18, 28 );
	bishop_outposts[0]              = score( 1, 7 );
	bishop_outposts[1]              = score( 8, 11 );
	trapped_rook[0].mg()            = -25;
	trapped_rook[1].mg()            = -114;
