...
void init()
{
	...
	// Tweaked values
	material_values[pieces::pawn]   = score( 68, 73 );
	material_values[pieces::knight] = score( 316, 340 );
	material_values[pieces::bishop] = score( 356, 369 );
	material_values[pieces::rook]   = score( 474, 584 );
	material_values[pieces::queen]  = score( 1142, 1018 );
	double_bishop                   = score( 39, 36 );
	passed_pawn_advance_power       = score( 210, 158 );
	passed_pawn_king_distance[0]    = score( 0, 4 );
	passed_pawn_king_distance[1]    = score( 0, 2 );
	passed_pawn_base[0]             = score( 3, 8 );
	passed_pawn_base[1]             = score( 0, 2 );
	passed_pawn_base[2]             = score( 0, 0 );
	passed_pawn_base[3]             = score( 0, 0 );
	doubled_pawn_base[0][0]         = score( 7, 9 );
	doubled_pawn_base[0][1]         = score( 1, 1 );
	doubled_pawn_base[0][2]         = score( 1, 3 );
	doubled_pawn_base[0][3]         = score( 1, 3 );
	doubled_pawn_base[1][0]         = score( 9, 0 );
	doubled_pawn_base[1][1]         = score( 3, 0 );
	doubled_pawn_base[1][2]         = score( 0, 0 );
	doubled_pawn_base[1][3]         = score( 0, 0 );
	backward_pawn_base[0][0]        = score( 9, 0 );
	...
	backward_pawn_base[1][1]        = score( 0, 2 );
	backward_pawn_base[1][2]        = score( 2, 0 );
	backward_pawn_base[1][3]        = score( 3, 1 );
	isolated_pawn_base[0][0]        = score( 15, 2 );
	isolated_pawn_base[0][1]        = score( 4, 0 );
	isolated_pawn_base[0][2]        = score( 3, 0 );
	isolated_pawn_base[0][3]        = score( 4, 0 );
	isolated_pawn_base[1][0]        = score( 7, 16 );
	isolated_pawn_base[1][1]        = score( 1, 2 );
	isolated_pawn_base[1][2]        = score( 2, 0 );
	isolated_pawn_base[1][3]        = score( 0, 0 );
	connected_pawn_base[0][0]       = score( 0, 1 );
	connected_pawn_base[0][1]       = score( 0, 0 );
	connected_pawn_base[0][2]       = score( 0, 0 );
	connected_pawn_base[0][3]       = score( 0, 0 );
	connected_pawn_base[1][0]       = score( 5, 1 );
	connected_pawn_base[1][1]       = score( 0, 0 );
	connected_pawn_base[1][2]       = score( 0, 0 );
	connected_pawn_base[1][3]       = score( 0, 0 );
	candidate_passed_pawn_base[0]   = score( 9, 18 );
	candidate_passed_pawn_base[1]   = score( 0, 0 );
	candidate_passed_pawn_base[2]   = score( 3, 6 );
	candidate_passed_pawn_base[3]   = score( 3, 6 );
	pawn_shield[0]                  = score( 31, 2 );
	pawn_shield[1]                  = score( 17, 1 );
	pawn_shield[2]                  = score( 11, 0 );
	pawn_shield_attack[0]           = score( 5, 0 );
	pawn_shield_attack[1]           = score( 4, 0 );
	pawn_shield_attack[2]           = score( 4, 0 );
	absolute_pin[1]                 = score( 1, 1 );
	absolute_pin[2]                 = score( 1, 54 );
	absolute_pin[3]                 = score( 1, 0 );
	absolute_pin[4]                 = score( 0, 0 );
	absolute_pin[5]                 = score( 5, 5 );
	rooks_on_open_file              = score( 18, 11 );
	rooks_on_half_open_file         = score( 6, 8 );
	...
	defended_by_pawn[1]             = score( 3, 8 );
	defended_by_pawn[2]             = score( 5, 0 );
	defended_by_pawn[3]             = score( 3, 0 );
	defended_by_pawn[4]             = score( 0, 1 );
	defended_by_pawn[5]             = score( 0, 4 );
	attacked_piece[1]               = score( 1, 8 );
	attacked_piece[2]               = score( 2, 17 );
	attacked_piece[3]               = score( 7, 8 );
	attacked_piece[4]               = score( 4, 15 );
	attacked_piece[5]               = score( 17, 20 );
	hanging_piece[1]                = score( 7, 9 );
	hanging_piece[2]                = score( 9, 9 );
	hanging_piece[3]                = score( 4, 19 );
	hanging_piece[4]                = score( 16, 14 );
	hanging_piece[5]                = score( 9, 39 );
	mobility_knight_min             = score( 0, -23 );
	mobility_knight_max             = score( 35, 4 );
	mobility_knight_rise            = score( 15, 10 );
	mobility_knight_offset          = score( 0, 2 );
	mobility_bishop_min             = score( -26, -63 );
	mobility_bishop_max             = score( 19, 0 );
	mobility_bishop_rise            = score( 5, 10 );
	mobility_bishop_offset          = score( 0, 0 );
	mobility_rook_min               = score( -11, -56 );
	mobility_rook_max               = score( 0, 0 );
	mobility_rook_rise              = score( 6, 6 );
	mobility_rook_offset            = score( 6, 2 );
	mobility_queen_min              = score( -27, -57 );
	mobility_queen_max              = score( 0, 0 );
	mobility_queen_rise             = score( 1, 39 );
	mobility_queen_offset           = score( 0, 0 );
	side_to_move                    = score( 6, 1 );
	rooks_on_rank_7                 = score( 0, 45 );
	knight_outposts[0]              = score( 20, 0 );
	knight_outposts[1]              = score( 11, 20 );
