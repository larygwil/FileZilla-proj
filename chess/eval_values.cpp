...
void init()
{
	...
	// Tweaked values
	material_values[pieces::pawn]   = score( 76, 90 );
	material_values[pieces::knight] = score( 316, 356 );
	material_values[pieces::bishop] = score( 332, 386 );
	material_values[pieces::rook]   = score( 633, 612 );
	material_values[pieces::queen]  = score( 1296, 1203 );
	double_bishop                   = score( 39, 38 );
	passed_pawn_advance_power       = score( 205, 156 );
	passed_pawn_king_distance[0]    = score( 0, 6 );
	passed_pawn_king_distance[1]    = score( 2, 4 );
	passed_pawn_base[0]             = score( 6, 9 );
	passed_pawn_base[1]             = score( 1, 1 );
	passed_pawn_base[2]             = score( 0, 0 );
	passed_pawn_base[3]             = score( 1, 0 );
	doubled_pawn_base[0][0]         = score( 14, 16 );
	doubled_pawn_base[0][1]         = score( 3, 5 );
	doubled_pawn_base[0][2]         = score( 2, 5 );
	doubled_pawn_base[0][3]         = score( 3, 4 );
	...
	backward_pawn_base[1][0]        = score( 10, 10 );
	backward_pawn_base[1][1]        = score( 3, 3 );
	backward_pawn_base[1][2]        = score( 2, 0 );
	backward_pawn_base[1][3]        = score( 1, 0 );
	isolated_pawn_base[0][0]        = score( 2, 4 );
	isolated_pawn_base[0][1]        = score( 0, 0 );
	isolated_pawn_base[0][2]        = score( 0, 1 );
	isolated_pawn_base[0][3]        = score( 0, 0 );
	isolated_pawn_base[1][0]        = score( 9, 18 );
	isolated_pawn_base[1][1]        = score( 3, 0 );
	isolated_pawn_base[1][2]        = score( 3, 0 );
	isolated_pawn_base[1][3]        = score( 2, 6 );
	connected_pawn_base[0][0]       = score( 1, 12 );
	connected_pawn_base[0][1]       = score( 0, 0 );
	connected_pawn_base[0][2]       = score( 0, 4 );
	connected_pawn_base[0][3]       = score( 0, 2 );
	connected_pawn_base[1][0]       = score( 8, 1 );
	connected_pawn_base[1][1]       = score( 0, 0 );
	connected_pawn_base[1][2]       = score( 0, 0 );
	connected_pawn_base[1][3]       = score( 0, 0 );
	candidate_passed_pawn_base[0]   = score( 18, 18 );
	candidate_passed_pawn_base[1]   = score( 0, 0 );
	candidate_passed_pawn_base[2]   = score( 5, 6 );
	candidate_passed_pawn_base[3]   = score( 6, 6 );
	pawn_shield[0]                  = score( 42, 1 );
	pawn_shield[1]                  = score( 33, 1 );
	pawn_shield[2]                  = score( 17, 1 );
	pawn_shield[3]                  = score( 7, 4 );
	pawn_shield_attack[0]           = score( 39, 62 );
	pawn_shield_attack[1]           = score( 16, 5 );
	pawn_shield_attack[2]           = score( 4, 6 );
	pawn_shield_attack[3]           = score( 4, 1 );
	absolute_pin[2]                 = score( 6, 26 );
	absolute_pin[3]                 = score( 9, 7 );
	absolute_pin[4]                 = score( 5, 1 );
	absolute_pin[5]                 = score( 1, 1 );
	rooks_on_open_file              = score( 18, 11 );
	rooks_on_half_open_file         = score( 11, 8 );
	connected_rooks                 = score( 4, 8 );
	tropism[1]                      = score( 1, 1 );
	tropism[2]                      = score( 3, 1 );
	tropism[3]                      = score( 1, 1 );
	tropism[4]                      = score( 1, 1 );
	...
	king_attack_by_piece[3]         = 16;
	king_attack_by_piece[4]         = 21;
	king_attack_by_piece[5]         = 17;
	king_check_by_piece[2]          = 3;
	king_check_by_piece[3]          = 10;
	king_check_by_piece[4]          = 1;
	king_check_by_piece[5]          = 3;
	king_melee_attack_by_rook       = 8;
	king_melee_attack_by_queen      = 18;
	king_attack_pawn_shield         = 27;
	center_control                  = score( 3, 1 );
	material_imbalance[0]           = score( 112, 33 );
	material_imbalance[1]           = score( 200, 79 );
	rule_of_the_square              = score( 5, 4 );
	passed_pawn_unhindered          = score( 13, 4 );
	defended_by_pawn[1]             = score( 1, 8 );
	defended_by_pawn[2]             = score( 3, 8 );
	defended_by_pawn[3]             = score( 0, 3 );
	defended_by_pawn[4]             = score( 8, 0 );
	defended_by_pawn[5]             = score( 0, 0 );
	attacked_piece[1]               = score( 0, 15 );
	attacked_piece[2]               = score( 0, 13 );
	attacked_piece[3]               = score( 5, 8 );
	attacked_piece[4]               = score( 8, 19 );
	attacked_piece[5]               = score( 15, 4 );
	hanging_piece[1]                = score( 1, 18 );
	hanging_piece[2]                = score( 14, 10 );
	hanging_piece[3]                = score( 24, 16 );
	hanging_piece[4]                = score( 14, 28 );
	hanging_piece[5]                = score( 24, 6 );
	mobility_rise[2]                = score( 15, 12 );
	mobility_rise[3]                = score( 10, 12 );
	mobility_rise[4]                = score( 12, 11 );
	mobility_rise[5]                = score( 4, 3 );
	mobility_min[2]                 = score( 2, 3 );
	mobility_min[3]                 = score( 2, 4 );
	mobility_min[4]                 = score( 12, 0 );
	mobility_min[5]                 = score( 24, 20 );
	mobility_duration[2]            = score( 1, 2 );
	mobility_duration[3]            = score( 3, 3 );
	mobility_duration[4]            = score( 2, 9 );
	mobility_duration[5]            = score( 3, 1 );
	side_to_move                    = score( 9, 3 );
	rooks_on_rank_7                 = score( 24, 30 );
	knight_outposts[0]              = score( 13, 10 );
	knight_outposts[1]              = score( 22, 24 );
	bishop_outposts[0]              = score( 6, 13 );
	bishop_outposts[1]              = score( 13, 11 );
	trapped_rook[0].mg()            = -13;
	trapped_rook[1].mg()            = -96;
