...
If you do use the latest version, please send the exception report to Tim.Kosse@gmx.de along with a brief explanation what you did before FileZilla Server crashed."), m_pLogFileName, m_pDmpFileName);
			MessageBox(0, tmp, _T("FileZilla Server - Unhandled eception"), MB_APPLMODAL | MB_OK | MB_ICONEXCLAMATION);
...
int CExceptionReport::sendMail()
{
	...
	mail.AddAttachment(m_pLogFileName, _T("FileZillaServer.rpt"));
	mail.AddAttachment(m_pDmpFileName, _T("FileZillaServer.dmp"));
