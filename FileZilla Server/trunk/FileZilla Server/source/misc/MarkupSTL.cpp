...
CStdString CMarkupSTL::x_GetAttrib( int iPos, LPCTSTR szAttrib ) const
{
...
bool CMarkupSTL::x_CreateNode( CStdString& csNode, int nNodeType, LPCTSTR szText )
{
...
CStdString CMarkupSTL::x_TextToDoc( LPCTSTR szText, bool bAttrib ) const
{
