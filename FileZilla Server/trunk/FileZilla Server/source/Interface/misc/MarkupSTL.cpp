...
bool CMarkupSTL::SetDoc( LPCTSTR szDoc )
{
	// Reset indexes
	m_iPosFree = 1;
	ResetPos();
...
bool CMarkupSTL::Load( LPCTSTR szFileName )
{
	CString csDoc;
	CFile file;
...
bool CMarkupSTL::FindElem( LPCTSTR szName )
{
...
bool CMarkupSTL::FindChildElem( LPCTSTR szName )
{
...
CString CMarkupSTL::GetTagName() const
{
...
CString CMarkupSTL::GetAttribName( int n ) const
{
...
bool CMarkupSTL::SavePos( LPCTSTR szPosName )
{
...
bool CMarkupSTL::RestorePos( LPCTSTR szPosName )
{
	// Restore element position if found in saved position map
	if (!szPosName)
		return false;

	std::map<CString, SavedPos>::iterator iter=m_mapSavedPos.find( szPosName );
...
CString CMarkupSTL::GetChildSubDoc() const
{
	if ( m_iPosChild )
	{
...
int CMarkupSTL::x_ParseError( LPCTSTR szError, LPCTSTR szName )
{
	if ( szName )
...
bool CMarkupSTL::x_FindChar( LPCTSTR szDoc, int& nChar, _TCHAR c )
{
	// static function
...
CString CMarkupSTL::x_GetToken( const CMarkupSTL::TokenPos& token ) const
{
...
CString CMarkupSTL::x_GetTagName( int iPos ) const
{
...
bool CMarkupSTL::x_FindAttrib( CMarkupSTL::TokenPos& token, LPCTSTR szAttrib ) const
{
...
CString CMarkupSTL::x_GetAttrib( int iPos, LPCTSTR szAttrib ) const
{
...
bool CMarkupSTL::x_SetAttrib( int iPos, LPCTSTR szAttrib, int nValue )
{
...
bool CMarkupSTL::x_SetAttrib( int iPos, LPCTSTR szAttrib, __int64 nValue )
{
	// Convert integer to string and call SetChildAttrib
	_TCHAR szVal[25];
...
bool CMarkupSTL::x_SetAttrib( int iPos, LPCTSTR szAttrib, LPCTSTR szValue )
{
...
bool CMarkupSTL::x_CreateNode( CString& csNode, int nNodeType, LPCTSTR szText )
{
...
bool CMarkupSTL::x_SetData( int iPos, LPCTSTR szData, int nCDATA )
{
...
CString CMarkupSTL::x_GetData( int iPos ) const
{
...
CString CMarkupSTL::x_TextToDoc( LPCTSTR szText, bool bAttrib ) const
{
...
CString CMarkupSTL::x_TextFromDoc( int nLeft, int nRight ) const
{
...
void CMarkupSTL::x_DocChange( int nLeft, int nReplace, const CString& csInsert )
{
...
bool CMarkupSTL::x_AddElem( LPCTSTR szName, LPCTSTR szValue, bool bInsert, bool bAddChild )
{
	if ( bAddChild )
	{
...
bool CMarkupSTL::x_AddSubDoc( LPCTSTR szSubDoc, bool bInsert, bool bAddChild )
{
